...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__412EB0B6] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK__Account__F20699F640B4358B] PRIMARY KEY CLUSTERED  ([accountid])
GO
